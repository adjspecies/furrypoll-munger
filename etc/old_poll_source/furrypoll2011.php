...
<html>
  <head>
    <title>Furry Survey v.5.0.0</title>
  ...
  <p><span style="font-size: 200%; font-weight: bold; margin-left: 70px;">Furry Survey v 5.0.0</span> <br /><div style="font-size: 70%; position: absolute; left: 92px; top: 44px; font-weight:none; display: block;">Alex Osaki; <a href="mailto:bce@klisoura.com" title="bce@klisoura.com">bce@klisoura.com</a><br />Current version date: 18 January, 2011<br />Total questions: 32 + 5</div>
  </p>
  <div style="display: block; height:24px;"></div>

  <p>Welcome to the Furry Survey, new and improved for 2011! This version shares general commonality with last year's version, with the addition of a second optional section intended to provide some limited psychographic information. If you have questions before taking the survey, please feel free to avail yourself of the following links:</p>
  ...
  <div style="border: 1px solid black; margin-left: 10px; margin-right: 10px; padding-left: 10px; padding-right: 10px;"><p>NOTES FOR FURRY SURVEY 5:</P>
  ...
  <p>This survey is mostly identical to the one last year (on purpose, since the goal of running it multiple times is to track year-on-year changes). Here is a list of all the changes:
    <ul>
      <li>Added an "asexual" option to the Kinsey-derived sexual orientation scale.</li>
      <li>Added a list of US States and Canadian Provinces to track geographic skews.</li>
      <li>Added an "otherkin" option to the list of furry activities.</li>
  ...
  <form enctype="multipart/form-data" action="pollsql2011.php" method="post">
		 <?php
			$user="readaccess";
			$password="readpass";
			$database="surv1";
			...
			$sql = "SELECT date FROM furrypoll2011 WHERE entryip='".$_SERVER['REMOTE_ADDR']."'";
  ...
  <table class="polltable">
    ...
    <tr>
	<td class="bqlt">BA1. <div>Which of the following conventions have you attended? (or, for conventions taking place in 2011, which you will attend)</div></td>
	<td class="bqrt">
	  <table style="border:1px solid black;">
	    <tr>
		...
		<td class="tc1"><input name="form_allfurfun10" type="checkbox"></td>
		<td class="tc1"><input name="form_allfurfun11" type="checkbox"></td>
	    </tr>
	    <tr>
