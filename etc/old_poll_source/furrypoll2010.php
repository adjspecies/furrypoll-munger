...
<html>
  <head>
    <title>Furry Survey v.4.0.4</title>
  ...
  <p><span style="font-size: 200%; font-weight: bold; margin-left: 70px;">Furry Survey v 4.0.4</span> <br /><div style="font-size: 70%; position: absolute; left: 92px; top: 44px; font-weight:none; display: block;">Alex Osaki; <a href="mailto:bce@klisoura.com" title="bce@klisoura.com">bce@klisoura.com</a><br />Current version date: 28 January, 2010<br />Total questions: 32 + 5</div>
  </p>
  <div style="display: block; height:24px;"></div>

  <p>Welcome to the Furry Survey, new and improved for 2010! This version shares general commonality with last year's version, with the addition of a second optional section intended to provide some limited psychographic information. If you have questions before taking the survey, please feel free to avail yourself of the following links:</p>
  ...
  <p>The questions begin below. All of them are optional, so although the survey is completely anonymous, and I would prefer you to complete all of them, this is not required.</p>

  <div style="border: 1px solid black; margin-left: 10px; margin-right: 10px; padding-left: 10px; padding-right: 10px;"><p>NOTES FOR FURRY SURVEY 4:</P>
  ...
  <p>This survey is mostly identical to the one last year (on purpose, since the goal of running it multiple times is to track year-on-year changes). Here is a list of all the changes:
    <ul>
      <li>Clarified Q11 to clarify terms used less widely outside the USA</li>
      <li>Added a "pansexual" option to the Kinsey-derived sexual orientation scale.</li>
      <li>Expanded the convention list to incorporate by year (to track convention overlap and year-on-year attendance, also as a data sanity check)</li>
      <li>Expanded the question on political orientation to separate social and economic views.</li>
    </ul>
  </p>
  </div>

  <div style="border: 1px solid black; margin-left: 10px; margin-right: 10px; margin-top: 16px; margin-bottom: 16px; padding-left: 10px; padding-right: 10px; padding-top: 10px; padding-bottom: 10px; background-color: #ccc;">Other note: <br /><br />In the interests of full disclosure, this year I am going to make an effort to make the raw data from the survey public for other researchers (in particular, because people keep asking me questions -- mostly unique -- that require several hours of work on my part). If and when I do this, <em>all identifying information will be removed</em> (any text-based responses, unique identifying strings, etc). <em>Only</em> objective information will be recorded. If you have concerns about this, please register them with me at my <a href="mailto:bce@klisoura.com">e-mail address</a>, <em>bce@klisoura.com</em>. There has been some clamour for me to make the data available, and I want to do so, but I'm also sensitive to any potential concerns.</div>

  <div style="width: 100%; background-color: #CCC; font-family: 'Courier New'; text-align: center; ">Begin survey below</div>

  <form enctype="multipart/form-data" action="pollsql2010.php" method="post">
  <div align="center">
  ...
  <table class="polltable">
		 ...
		 <?php
			...
			$sql = "SELECT date FROM furrypoll2010 WHERE entryip='".$_SERVER['REMOTE_ADDR']."'";
	...
	<td class="dqrt">
	  ...
	  <input name="form_gender" type="radio" value="f">Other
	</td>
    </tr>
	...
	<td class="dqrt">
	  <table style="border: 1px solid black;">
	    ...
	    <tr>
	      <td colspan="12" style="text-align:center;">Other: <input name="form_politicsext" type="text" size="36"><hr /></td>
	    </tr>
	    <tr id="oqscaleopt">
	    ...
	    <tr>
	      <td colspan="12" style="text-align:center;">Other: <input name="form_economicsext" type="text" size="36"></td>
	    </tr>
	  </table>
	</td>
    </tr>
	...
	<td class="dqrt">
	  ...
	  <input name="form_occupation" type="radio" value="j">None<br />
    ...
    <tr>
	<td class="bqlt">BA1. <div>Which of the following conventions have you attended? (or, for conventions taking place in 2010, which you will attend)</div></td>
	<td class="bqrt">
	  <table style="border:1px solid black;">
	    <tr>
	...
	<td class="bqrt">
	  ...
	  <input name="form_website_yiffstar" type="checkbox"> SoFurry <br />
    ...
    <tr>
	<td class="bqlt">BA3. <div>If you identify with a particular animal or have a particular furry persona, what is it? <br /><br />Select multiple options if said animal is a hybrid. <br /><br />If the following choices are insufficient, feel free to write in one</div></td>
	<td class="bqrt">
	  ...
	  <hr />
	  <input name="form_animal_hyaena" type="checkbox"> Hyaena<br />
    ...
    <tr>
	<td class="bqlt">BA5. <div>Please add any additional comments here:</div></td>
	<td class="bqrt">
    ...
    <tr>
	<td class="bqlt">BA6. <div>Microsurveys:</div></td>
	<td class="bqrt">
